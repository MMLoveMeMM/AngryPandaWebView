...
public class NativeFunc {
	...
	static {
		try {
			...
			SetLoadSoState(false);
		}
	}
	private static void SetLoadSoState(boolean bState){
		LOAD_SO_FLAG = bState;
	}
	...
	public static native int mt9TouchBoardSetTime(int times);

	public static native int mt9TouchBoardGetVer(byte[] ver);
